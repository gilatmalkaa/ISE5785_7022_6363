...
class PointTests {
	 ...
	 * This test checks subtraction between two points,
     * and returns a vector from the second point to the first.
	 */
	@Test
	void testSubtract() {
	    ...
	    assertEquals(
	        new Vector(3, 2, 1),
	        new Point(5, 5, 5).subtract(new Point(2, 3, 4)),
	        "subtract() did not return the correct vector");
     ...
     * which should return a new point shifted by the vector.
	 */
	@Test
	void testAdd() {
		   // ============ Equivalence Partitions Tests ==============
	    ...
	    assertEquals(
	        ...
	        "add() did not return the correct point");
	    ...
	    // TC11: Add zero vector to P1 → should return P1
	    assertEquals(
	        P1,
	        P1.add(new Vector(0, 0, 0)),
	        "add() with zero vector should return the original point");
	}
	...
	@Test
		void testDistanceSquared() {
		    ...
		    assertEquals(
		        ...
		        "distanceSquared() did not return expected result");

		    // TC02: distanceSquared between P1 (1,2,3) and Point(2,3,4) → (1^2 + 1^2 + 1^2) = 3
		    assertEquals(
		        3,
		    ...
		    assertEquals(
		        ...
		        "distanceSquared() between same point should return 0");
		}


	/**
	 * Test method for {@link primitives.Point#distance(primitives.Point)}.
	 * This test checks the actual distance between two points.
	 */
	@Test
	void testDistance() {
		 // ============ Equivalence Partitions Tests ==============
	    ...
	    assertEquals(
	        ...
	        P1.distance(P2),
	        0.00001,
	        "distance() did not return expected result");

	    // TC02: distance between P2 (0,0,0) and Point(3,4,0) → should be 5 (3-4-5 triangle)
	    assertEquals(
	        5,
	        P2.distance(new Point(3, 4, 0)),
	        0.00001,
	        "distance() did not return expected result");
	    ...
	    assertEquals(
	        ...
	        P1.distance(P1),
	        0.00001,
	        "distance() between same point should return 0");
	}
