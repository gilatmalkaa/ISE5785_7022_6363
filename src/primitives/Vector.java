...
public class Vector extends Point {
	...
	/**
	 * Calculates the scalar product (dot product) of this vector and another
	 * vector.
	 *
	...
	/**
	 * Calculates the vector product (cross product) of this vector and another
	 * vector. Returns a new vector that is perpendicular to both vectors.
	 *
	 * @param vector the vector to calculate the cross product with
	 * @return a vector that is perpendicular to both vectors
	 */
	public Vector crossProduct(Vector vector) {
		// Calculation of a vector cross product according to the formula of Linear
		// Algebra
	 ...
	 * @return true if the object is a Vector and is equal to this vector, false
	 *         otherwise
	 */
	@Override
